...
export class InventoryListComponent implements OnInit, AfterViewInit, OnDestroy
{
    ...
    toggleDetails(productId: string): void
    {
        ...
        if ( this.selectedProduct && this.selectedProduct.code === productId )
        {
            // Close the details
            this.closeDetails();
            return;
    ...
    updateSelectedProduct(): void
    {
        ...
        this._inventoryService.updateProduct(product.code, product).subscribe(() => {
    ...
    deleteSelectedProduct(): void
    {
        ...
        this._inventoryService.deleteProduct(product.code).subscribe(() => {
    ...
    showSuccess() {
        this._toastr.success('Cập nhật thông tin sản phẩm', 'Cập nhật thành công');
    }
}
