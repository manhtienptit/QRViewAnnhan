...
import {Contact, Contacts, Country, Tag} from 'app/modules/admin/apps/contacts/contacts.types';
...
export class ContactsService
{
    ...
    getContacts(): Observable<Contacts>
    {
        ...
        return this._httpClient.post<Contacts>(`${environment.baseUrl}user/get-customers` , {})
               .pipe(
                tap((contacts) => {
